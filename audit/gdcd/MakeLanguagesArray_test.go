...
func TestIoCodeBlockLanguagesCountCorrectly(t *testing.T) {
	...
	languagesArray := MakeLanguagesArray([]types.CodeNode{}, []types.ASTNode{}, []types.ASTNode{swiftIoCodeBlock, goIoCodeBlock, anotherGoIoCodeBlock})
...
func TestLiteralIncludeNodeLanguagesCountCorrectly(t *testing.T) {
	...
	languagesArray := MakeLanguagesArray([]types.CodeNode{}, []types.ASTNode{swiftLiteralInclude, goLiteralInclude, anotherGoLiteralInclude}, []types.ASTNode{})
